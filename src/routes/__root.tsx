...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Portfolio of Astel Antony — aspiring Generative AI Engineer and Cybersecurity professional from Kerala, India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Astel Antony — Generative AI & Cybersecurity" },
